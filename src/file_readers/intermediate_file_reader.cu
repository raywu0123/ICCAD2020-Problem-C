...
void IntermediateFileReader::summary() {
    cout << "Summary of intermediate file" << endl;
    cout << "Design Name: " << g.design_name << endl;
    cout << "Number of standard cells: " << StandardCellLibrary::cells.size() << endl;

    cout << "Number of gv io: " << endl;
    cout << "input: " << g.gv_io[GV_INPUT].size() << endl;
    cout << "output: " << g.gv_io[GV_OUTPUT].size() << endl;
    cout << "wire: " << g.gv_io[GV_WIRE].size() << endl;

    cout << "Number of multibit gv io: " << endl;
    cout << "input: " << g.gv_multibit_io[GV_INPUT].size() << endl;
    cout << "output: " << g.gv_multibit_io[GV_OUTPUT].size() << endl;
    cout << "wire: " << g.gv_multibit_io[GV_WIRE].size() << endl;

    cout << "Number of gv assign: " << g.gv_assign.size() << endl;
    cout << "Number of gv cells: " << g.gv_cells.size() << endl;
